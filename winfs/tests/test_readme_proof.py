...
class ReadmePackageProofTests(PostgresTestCase):
    def test_public_readme_and_package_metadata(self):
        pyproject = (ROOT / "pyproject.toml").read_text(encoding="utf-8")
        self.assertIn('name = "django-trusts-windows-acl"', pyproject)
        ...
        self.assertIn('authors = [{ name = "BeeDesk, Inc." }]', pyproject)
    ...
    def test_license_is_bsd_2_clause_with_exact_holder(self):
